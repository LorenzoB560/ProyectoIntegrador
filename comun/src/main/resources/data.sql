...
-- INSERT INTO nomina (id, mes, annio, total_liquido, empleado_id)
-- VALUES (@nomina_id,
--         5,
--         2025,
--         2050.00,
--         UNHEX('B3C7D8E9F0A1B2C3D4E5F6A7B8C9D0E1') -- UUID de empleado existente
--        );

-- Líneas de nómina para la nómina 1
-- INSERT INTO linea_nomina (id, concepto_id, cantidad, nomina_id)
-- VALUES (UNHEX(REPLACE(UUID(), '-', '')), 1, 2500.00, @nomina_id), -- Salario base
--        (UNHEX(REPLACE(UUID(), '-', '')), 4, -450.00, @nomina_id);
-- -- IRPF
--
-- -- Nómina ejemplo 2 (Abril 2025)
-- SET
-- @nomina_id = UNHEX(REPLACE(UUID(), '-', ''));
-- INSERT INTO nomina (id, mes, annio, total_liquido, empleado_id)
-- VALUES (@nomina_id,
--         4,
--         2025,
--         1850.00,
--         UNHEX('B3C7D8E9F0A1B2C3D4E5F6A7B8C9D0E1') -- Mismo empleado
--        );
--
-- -- Líneas de nómina para la nómina 2
-- INSERT INTO linea_nomina (id, concepto_id, cantidad, nomina_id)
-- VALUES (UNHEX(REPLACE(UUID(), '-', '')), 1, 2000.00, @nomina_id), -- Salario base
--        (UNHEX(REPLACE(UUID(), '-', '')), 2, 150.00, @nomina_id),  -- Horas extras
--        (UNHEX(REPLACE(UUID(), '-', '')), 4, -300.00, @nomina_id); -- IRPF
